...
class AuthorizeNetTD extends AuthorizeNetRequest
{
    ...
    protected function _setPostString()
    {
        ...
        // Manually add the namespace the the XML string (SimpleXML workaround)
        $this->_post_string = str_replace('<'.$this->request_type.'>', '<'.$this->request_type.' xmlns="AnetApi/xml/v1/schema/AnetApiSchema.xsd">', $this->_post_string);
    }
