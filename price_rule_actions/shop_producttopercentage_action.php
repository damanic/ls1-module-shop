<?
	...
	class Shop_ProductToPercentage_Action extends Shop_RuleActionBase
	{
		...
		{
			$host_obj->add_field('discount_amount', 'Discount amount', 'full', db_float)->comment('Please specify a percentage of the original product price to use as a final product price.', 'above')->validation()->required('Please specify discount amount');
		}
